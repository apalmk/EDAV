...
ui <- # Use a fluid Bootstrap layout
    fluidPage(    
        ...
        sidebarLayout(      
            ...
            mainPanel(
                p("This shiny app is made for the purpose of testing our assumption that movie production houses tend to look at old patterns of movie genres and their financial success and try to make more movies of similar genre to earn high revenues. We did this by making a scatter plot 
